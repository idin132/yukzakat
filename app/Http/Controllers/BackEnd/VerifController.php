...
class VerifController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('BackEnd.verif.index', compact('verif', 'verifikasi'));
    }
    ...
    public function create()
    {
        ...
        return view('BackEnd.verif.create', [
            'verif' => $verif,
        ]);
    }
    ...
    public function show($id)
    {
        ...
        return view('BackEnd.verif.detail', compact('verif'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('BackEnd.verif.show', [
            "verif" => $verif,
        ]);
    }
