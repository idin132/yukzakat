...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs5/jq-3.6.0/dt-1.12.1/datatables.css"/>
</head>
...
<div class="wrapper">
  <!-- Navbar -->
  <div class="container">
  <nav class="main-header navbar navbar-expand navbar-white fixed-top navbar-dark" style="background-color: #343a40;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
...
-->
<script type="text/javascript" src="https://cdn.datatables.net/v/bs5/jq-3.6.0/dt-1.12.1/datatables.js"></script>
